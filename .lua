...
-- Updated to use latest Lucide icons from CDN: https://cdn.jsdelivr.net/npm/lucide-static@latest/tags.json
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://cdn.jsdelivr.net/npm/lucide-static@latest/tags.json')
-- Variables
